        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-xs text-text-muted text-center">
              © {new Date().getFullYear()} ReHome • An Entity of <span className="font-[600]" style={{ fontFamily: "'Clash Display', -apple-system, sans-serif", fontWeight: 600 }}>T-I-Z-Z-L-E</span>
            </div>
          </div>
        </div>
      </footer>
